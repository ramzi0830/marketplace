    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md rounded-3xl border border-red-600/20 bg-white/5 p-8 shadow-[0_0_60px_rgba(225,16,0,0.12)] backdrop-blur-xl">
        <div className="mb-8 text-center">
          <p className="text-sm uppercase tracking-[0.35em] text-red-500">Create access</p>
          <h1 className="mt-4 text-3xl font-semibold">Sign up for a new account</h1>
          <p className="mt-3 text-sm text-slate-400">Register with your email and password to enter the marketplace.</p>
        </div>
